...
module "resource_group" {
  source    = "./modules/rgroup-n01653029"
...
module "network" {
  source              = "./modules/network-n01653029"
  humber_id           = var.humber_id
  location            = var.location
...
module "common_services" {
  source              = "./modules/common_services-n01653029"
  humber_id           = var.humber_id
  location            = var.location
  resource_group_name = module.resource_group.rg_name
  tags                = var.tags
...
module "linux_vms" {
  source                     = "./modules/vmlinux-n01653029"
  humber_id                  = var.humber_id
  location                   = var.location
  resource_group_name        = module.resource_group.rg_name
  ...
  log_analytics_workspace_id = module.common_services.log_analytics_workspace_id
}
...
module "windows_vms" {
  source                     = "./modules/vmwindows-n01653029"
  humber_id                  = var.humber_id
  location                   = var.location
  resource_group_name        = module.resource_group.rg_name
  subnet_id                  = module.network.subnet_id
...
module "data_disks" {
  source              = "./modules/datadisk-n01653029"
  humber_id           = var.humber_id
  location            = var.location
  resource_group_name = module.resource_group.rg_name
...
module "database" {
  source                  = "./modules/database-n01653029"
  humber_id               = var.humber_id
  location                = var.location
  resource_group_name     = module.resource_group.rg_name
   admin_username          = var.admin_username
...
module "load_balancer" {
  source              = "./modules/loadbalancer-n01653029"
  humber_id           = var.humber_id
  location            = var.location
  resource_group_name = module.resource_group.rg_name
  tags                = var.tags
